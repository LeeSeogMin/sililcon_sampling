...
**방법**:
- 동일 일자에 GPT-4o-mini, GPT-5.2, CLOVA 동시 실험
- 6개 변수, n=100

**예상 비용**: 약 1,800 API 호출

---

### 3.4 층화 페르소나 실험 (M2 대응)

**목적**: 단일 페르소나 한계 극복

**현재 상태**: 이미 100개 층화 페르소나 존재 (`results/personas/personas_100.json`)

**확인 필요**:
- 현재 실험이 단일 페르소나인지 층화 페르소나인지 검증
- 단일이면 층화 페르소나로 재실험
